...
export const VagaListItemSchema = z
    .object({
        ...
        headcountOcupado: z.number().optional().nullable(),
    })
    .passthrough();
...
export const CandidatoSchema = z
    .object({
        ...
        status: z.string().optional().nullable(),
        trabalhandoAtualmente: z.boolean().optional().nullable(),
...
export const AgendaEventApiSchema = z.object({
    ...
    meetingFormat: z.string().optional().nullable(),
    roomEmail: z.string().optional().nullable(),
    roomDisplayName: z.string().optional().nullable(),
    owner: z.string().optional().nullable(),
    candidate: z.string().optional().nullable(),
    vagaTitle: z.string().optional().nullable(),
    vagaCode: z.string().optional().nullable(),
    notes: z.string().optional().nullable(),
    candidaturaId: z.string().optional().nullable(),
    candidatoId: z.string().optional().nullable(),
    vagaId: z.string().optional().nullable(),
    candidateResponseStatus: z.string().optional().nullable(),
    candidateRespondedAtUtc: z.string().optional().nullable(),

...
namespace RHPortal.Api.Migrations.Master
{
    ...
    [Migration("20260507123755_AddTenantTotvsGestorHierarchySettings")]
    partial class AddTenantTotvsGestorHierarchySettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RhPortal.Api.Domain.Entities.OwnerAwsSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("OwnerAwsSettings", (string)null);
                });
            ...
            modelBuilder.Entity("RhPortal.Api.Domain.Entities.TenantTotvsGestorHierarchySettings", b =>
                {
                    b.Property<string>("TenantId")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<string>("ConsultaUrlTemplate")
                        .IsRequired()
                        .HasMaxLength(2048)
                        .HasColumnType("character varying(2048)");

                    b.Property<int>("DefaultCodColigada")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(1);

                    b.Property<int>("DelayMsBetweenRequests")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(250);

                    b.Property<string>("HttpUser")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.ToTable("TenantTotvsGestorHierarchySettings", (string)null);
                });

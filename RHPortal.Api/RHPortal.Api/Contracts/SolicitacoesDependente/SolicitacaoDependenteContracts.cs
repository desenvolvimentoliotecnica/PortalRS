...
public sealed record SolicitacaoDependenteListQuery(string? Q, SolicitacaoStatus? Status, SolicitacaoStatus[]? Statuses, bool? ApenasMeus, int? Page, int? PageSize);

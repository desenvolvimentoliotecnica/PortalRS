...
public static class ModuleCatalog
{
    ...
    public static readonly IReadOnlyList<ModuleDefinition> All = new List<ModuleDefinition>
    {
        ...
        new("recrutamento",    "Recrutamento",        "Vagas, solicitações, aprovações, projetos e processo seletivo", IsCore: false, PermissionKeyPrefixes: ["vagas.", "solicitacoes-vaga.", "aprovacoes-vaga.", "propostas-vaga.", "projetos.", "processo-seletivo.", "rh."], PackageKey: "recrutamento-selecao"),

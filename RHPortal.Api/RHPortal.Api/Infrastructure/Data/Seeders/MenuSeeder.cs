...
public static class MenuSeeder
{
    ...
    [
        ...
        ("/Admin/Logs", "bi-activity", 94, "audit.view", true, "Seed.Menu.LogsTransacionais", null),
        ("/Admin/OperationalLogs", "bi-journal-text", 95, "logs.view", true, "Seed.Menu.LogsOperacionais", null),

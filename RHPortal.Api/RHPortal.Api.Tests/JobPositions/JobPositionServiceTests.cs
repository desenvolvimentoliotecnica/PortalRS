...
public sealed class JobPositionServiceTests
{
    ...
    private static JobPositionCreateRequest RequestMinimo(Guid areaId, string code = "CAR-001") =>
        new(code, "Cargo Teste", CargoStatus.Active, areaId, SeniorityLevel.Pleno, null, "0-00-00-00", null, null, null, null, null, null, null);
    ...
    public async Task Create_CamposOpcionaisPreenchidos_SaoPersistidos()
    {
        ...
        var request = new JobPositionCreateRequest(
            ...
            SeniorityLevel.Senior, "Técnico", "0-00-00-00", "Desenvolve sistemas web", null, null, null, null, null, null);
    ...
    public async Task Update_IdInexistente_RetornaNull()
    {
        ...
        var request = new JobPositionUpdateRequest(
            "CAR-X01", "Nome", CargoStatus.Active, areaId, SeniorityLevel.Junior, null, "0-00-00-00", null, null, null, null, null, null, null);
    ...
    public async Task Update_CodigoConflitanteComOutroCargo_LancaInvalidOperationException()
    {
        ...
        var request = new JobPositionUpdateRequest(
            "CAR-A01", "Novo Nome", CargoStatus.Active, areaId, SeniorityLevel.Pleno, null, "0-00-00-00", null, null, null, null, null, null, null);
    ...
    public async Task Update_MesmoCodigoNoProprioItem_Funciona()
    {
        ...
        var request = new JobPositionUpdateRequest(
            ...
            SeniorityLevel.Senior, "Técnico", "0-00-00-00", "Descrição nova", null, null, null, null, null, null);
    ...
    public async Task ListGrid_FiltroStatus_RetornaApenasFiltrados()
    {
        ...
        await svc.CreateAsync(
            new JobPositionCreateRequest("CAR-AT1", "Ativo", CargoStatus.Active, areaId, SeniorityLevel.Pleno, null, "0-00-00-00", null, null, null, null, null, null, null),
            CancellationToken.None);
        await svc.CreateAsync(
            new JobPositionCreateRequest("CAR-IN1", "Inativo", CargoStatus.Inactive, areaId, SeniorityLevel.Pleno, null, "0-00-00-00", null, null, null, null, null, null, null),
            CancellationToken.None);
    ...
    public async Task ListGrid_FiltroSeniority_RetornaApenasFiltrados()
    {
        ...
        await svc.CreateAsync(
            new JobPositionCreateRequest("CAR-JN1", "Junior", CargoStatus.Active, areaId, SeniorityLevel.Junior, null, "0-00-00-00", null, null, null, null, null, null, null),
            CancellationToken.None);
        await svc.CreateAsync(
            new JobPositionCreateRequest("CAR-SR1", "Senior", CargoStatus.Active, areaId, SeniorityLevel.Senior, null, "0-00-00-00", null, null, null, null, null, null, null),
            CancellationToken.None);
